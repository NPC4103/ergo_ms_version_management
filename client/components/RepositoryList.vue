        ...
        <div class="col" v-for="repo in rows" :key="repo.public_id">
            <div class="card h-100 shadow-sm border-0 repo-card">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <router-link :to="{ name: 'RepositoryDetail', params: { id: repo.public_id } }" class="dropdown-item">
                                        Открыть
                                    </router-link>
                                </li>
                ...
                <div class="card-footer bg-transparent border-0 pb-3 pt-0">
                     <router-link :to="{ name: 'RepositoryDetail', params: { id: repo.public_id } }" class="btn btn-outline-primary w-100 btn-sm">
...
<style scoped>
.repository-list-page { padding: 20px; }
.repo-card {
